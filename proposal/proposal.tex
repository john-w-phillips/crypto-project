...
keys that could be generated during key generation. We'd like to
explore one such instance, and see if a similar vulnerability that is
easy to exploit could still be introduced into the codebase with a
small modification to the base source of openssl.
\end{abstract}
