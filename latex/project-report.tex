...
Because of infamous vulerability that OpenSSL had in the past,
in this paper, we aim to understand one of the vulnerabilities
...
vulnerability of the past could be detected with methods
