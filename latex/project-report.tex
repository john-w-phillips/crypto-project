...
When fuzz testing the intentional vulerability with the current codebase, 
we definitely could have waited longer. However, due to the lack of time, we limited
it to 3 minutes until the tests found anything. If the experiment were to be
conducted again, we could try and increase the wait time to 15, or 30 mintues
per fuzzer.
...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[scale=0.4]{asn1-fuzz-timeout}
\end{figure}
